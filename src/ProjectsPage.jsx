...
const projects = [
  ...
  {
    id: 'proj6',
    titleTr: 'Jarvis — El Hareket Kontrollü AI Asistan',
    titleEn: 'Jarvis — Hand Gesture AI Desktop Assistant',
    descTr: 'OpenCV ve MediaPipe ile el hareketleri ve sesli komutlarla çalışan yapay zeka destekli masaüstü asistan.',
    descEn: 'AI-powered desktop assistant with hand gesture control and voice commands using OpenCV & MediaPipe.',
    github: 'https://github.com/Serkan-design/jarvis-hand-control-ai',
    techs: [
      { name: 'Python', color: '#3776AB' },
      { name: 'OpenCV', color: '#5C3EE8' },
      { name: 'MediaPipe', color: '#00BCD4' },
      { name: 'Speech Rec.', color: '#FF6B35' },
    ],
    icon: Terminal,
    accent: '#00BCD4',
  },
  {
    id: 'proj7',
    titleTr: 'ESP Home Automation — Siri ile Lamba Kontrolü',
    titleEn: 'ESP Home Automation — Lamp Control with Siri',
    descTr: 'ESP8266/ESP32 ve Apple HomeKit entegrasyonu sayesinde Siri sesli komutuyla akıllı lamba kontrolü.',
    descEn: 'Smart lamp control via Siri voice commands using ESP8266/ESP32 and Apple HomeKit integration.',
    github: 'https://github.com/Serkan-design/esp-home-automation',
    techs: [
      { name: 'ESP32', color: '#E7352B' },
      { name: 'C++', color: '#00599C' },
      { name: 'HomeKit', color: '#4EAA25' },
      { name: 'IoT', color: '#FF9500' },
    ],
    icon: Cpu,
    accent: '#4EAA25',
  },
  {
    id: 'proj8',
    titleTr: 'Price Tracker Bot — Akıllı Fiyat Takip Sistemi',
    titleEn: 'Price Tracker Bot — Smart Price Tracking System',
    descTr: 'Web scraping, otomatik fiyat alarmları ve Telegram bildirimleri ile donatılmış akıllı fiyat takip ve otomasyon sistemi.',
    descEn: 'A smart price tracking system with web scraping, automated price alerts, and Telegram notifications.',
    github: 'https://github.com/Serkan-design/price-tracker-bot',
    techs: [
      { name: 'Node.js', color: '#4EAA25' },
      { name: 'JavaScript', color: '#F7DF1E' },
      { name: 'Puppeteer', color: '#40B5A4' },
      { name: 'Telegram API', color: '#229ED9' },
    ],
    icon: Database,
    accent: '#4EAA25',
  },
